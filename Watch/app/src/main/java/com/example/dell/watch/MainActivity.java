...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new MainActivity.ButtonClickListener());
        btn_change.setOnClickListener(new MainActivity.ButtonClickListener());
        btn_changeHand.setOnClickListener(new MainActivity.ButtonClickListener());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            CDialog dialog = new CDialog(MainActivity.this,num,R.style.dialog);
            dialog.show();
            return true;
        }
    ...
    public void Start(View v) {
        ...
        recordingTimeWhite = time.getBaseTime();
    ...
    public void onContinueStart(View v) {
        if (isPause) stop();
        isPause = false;
        if (count % 2 == 1) leftTime = recordingTimeDark;
        else leftTime = recordingTimeWhite;
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (cnt == 0 && count % 2 == 1) {
                            chronometer.setText("白棋\n赢了");
                            vibrator.vibrate(new long[]{1000, 100, 1000, 100}, -1);
                            isPause = true;
                        }
                        if (cnt == 0 && count % 2 == 0) {
                            chronometer.setText("黑棋\n赢了");
